        ...
        <>
            <div className="bg-black">
                <ul className="flex border-b">
                    ...
                    <li className="mr-1">
                        <Link to="/sac" className="bg-black inline-block focus:border-l focus:border-t focus:border-r py-2 px-4 text-indigo-400 hover:text-blue-800 font-semibold" href="#">View Characters</Link>
                    </li>
                    <li className="mr-1">
