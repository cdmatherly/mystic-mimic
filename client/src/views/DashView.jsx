            ...
            <div className="bg-black">
                <ul className="flex border-b justify-between">
                    <div className="flex">
                        ...
                        <li className="mr-1">
                            <Link className="bg-black inline-block focus:border-l focus:border-t focus:border-r py-2 px-4 text-violet-400 hover:text-blue-800 font-semibold" href="#">Create Campaign</Link>
                        </li>
                        <li className="mr-1">
