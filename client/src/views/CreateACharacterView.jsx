                        ...
                        <div className="relative max-w-full rounded overflow-hidden shadow-lg px-20 py-10 bg-white">
                            ...
                            <form onSubmit={(e) => handleCreateACharacter(e)} className="w-full max-w-sm relative py-6">
                                ...
                                <div className="md:flex md:items-center mb-6">
                                    ...
                                    <div className="md:w-2/3">
                                        <select value={race} onChange={ (event) => setRace(event.target.value) } className="w-full bg-gray-200 border-2 border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                                            {races.map((race) =>
                                ...
                                <div className="md:flex md:items-center mb-6">
                                    ...
                                    <div className="md:w-2/3">
                                        <select value={className} onChange={ (event) => setClassName(event.target.value) } className="w-full bg-gray-200 border-2 border-gray-200 text-gray-700 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
