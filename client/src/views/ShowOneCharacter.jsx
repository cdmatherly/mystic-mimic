        ...
        <div className=''>
            {!isUserLoading && !isCharacterLoading && (
                <div className='flex relative justify-center'>
                    ...
                    <button className={'text-red-500 absolute right-0 -mr-12  transition-opacity ease-in-out duration-300 delay-300 ' + (isChatOpen ? ' opacity-0 ' : ' opacity-100 ')} onClick={() => setIsChatOpen(true)}>OPEN</button>
