                        ...
                        <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"
                            ...
                            <div className="flex justify-center items-center h-full">
                                ...
                                <h1 className="mb-4 text-3xl font-extrabold text-gray-500 md:text-6xl lg:text-8xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-purple-500 from-sky-400">Mystic</span> Mimic</h1>
                                    ...
                                    <Link to='/register'>
                                        <button type="button"
                                            className="inline-block px-7 py-3 border-2 border-white text-white font-medium text-sm leading-snug uppercase rounded hover:bg-black hover:bg-opacity-15 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
